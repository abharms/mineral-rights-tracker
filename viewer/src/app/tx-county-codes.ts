// Texas county name -> RRC 3-digit county code, extracted from RRC's own
// published table ("TEXAS COUNTIES AND COUNTY CODES", OGA049 manual, Appendix III).
// Used to reconcile the two TX sources: the permit file only carries the numeric
// code, the wellbore file carries the name.
export const TX_COUNTY_CODE_TO_NAME: Record<string, string> = {
  ...
  "305": "LYNN", "307": "MC CULLOCH", "309": "MC LENNAN", "311": "MC MULLEN",
...
export const TX_COUNTY_NAME_TO_CODE: Record<string, string> = Object.fromEntries(
  Object.entries(TX_COUNTY_CODE_TO_NAME).map(([code, name]) => [name, code]),
);
