...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      raw_tx_wellbore: {
        Row: {
          ...
          operator_name: string | null
          raw: Json
          standard_api_number: string
          well_no_display: string | null
          well_status: string | null
        }
        Insert: {
          api_depth?: string | null
    ...
    Enums: {
      activity_record_type: "well" | "permit"
      interest_type: "mineral" | "royalty" | "npri"
      subscription_status: "trialing" | "active" | "past_due" | "canceled"
      subscription_tier: "trial" | "tier1" | "tier2"
    }
    CompositeTypes: {
      geometry_dump: {
        path: number[] | null
